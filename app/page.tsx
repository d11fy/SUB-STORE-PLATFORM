...
const themeCards = [
  {
    ...
    emoji: "👗",
    bgClass: "from-pink-500/10 via-rose-500/5 to-transparent text-rose-700 border-rose-100",
    desc: "تصميم عصري يعرض الملابس وتفاصيل المقاسات والألوان بوضوح وسلاسة.",
  },
  {
    title: "ثيم تك",
    category: "منتجات رقمية وإلكترونيات",
    emoji: "💻",
    bgClass: "from-blue-500/10 via-indigo-500/5 to-transparent text-blue-700 border-blue-100",
    desc: "مناسب لبيع الأجهزة، الاشتراكات، والملفات القابلة للتحميل مباشرة.",
  },
  {
    title: "ثيم بريق",
    category: "إكسسوارات ومجوهرات",
    emoji: "💍",
    bgClass: "from-amber-500/10 via-yellow-500/5 to-transparent text-amber-700 border-amber-100",
    desc: "تصميم فاخر يركز على جودة الصور والزوايا القريبة للمنتجات الفريدة.",
  },
  {
    title: "ثيم لقمة",
    category: "مطاعم وحلويات",
    emoji: "🍰",
    bgClass: "from-emerald-500/10 via-teal-500/5 to-transparent text-emerald-700 border-emerald-100",
    desc: "يتيح تصفح المنيو بسهولة وتحديد خيارات الوجبات والتوصيل السريع.",
  },
];
    ...
    <div className="bg-[#FAF9F6] text-slate-900 min-h-screen font-cairo overflow-x-hidden selection:bg-[#1B4FD8]/10 selection:text-[#1B4FD8]">
      ...
      <nav className="sticky top-0 z-50 backdrop-blur-lg bg-[#FAF9F6]/90 border-b border-slate-200/40 transition-all duration-300 shadow-sm">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between h-20">
          ...
          <div className="hidden md:flex items-center gap-8">
            <a href="#features" className="text-[15px] font-semibold text-slate-600 hover:text-[#1B4FD8] hover:translate-y-[-1px] transition-all duration-200">
              المميزات
            </a>
            <a href="#how-it-works" className="text-[15px] font-semibold text-slate-600 hover:text-[#1B4FD8] hover:translate-y-[-1px] transition-all duration-200">
              كيف نعمل
            </a>
            <a href="#themes" className="text-[15px] font-semibold text-slate-600 hover:text-[#1B4FD8] hover:translate-y-[-1px] transition-all duration-200">
              الثيمات
            </a>
            <a href="#pricing" className="text-[15px] font-semibold text-slate-600 hover:text-[#1B4FD8] hover:translate-y-[-1px] transition-all duration-200">
              الأسعار
            </a>
          </div>
          ...
          <div className="flex items-center gap-5">
            <Link
              href="/login"
              className="text-[15px] font-bold text-slate-600 hover:text-[#1B4FD8] transition-colors px-3 py-2"
            >
              تسجيل الدخول
            </Link>
            <Link
      ...
      <section className="relative pt-6 pb-12 lg:pt-10 lg:pb-16 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
          ...
          <div className="lg:col-span-5 space-y-6 text-right z-10">
            ...
            {/* Main Headline */}
            <h1 className="font-cairo font-black text-slate-950 leading-[1.3] tracking-tight text-3xl sm:text-4xl lg:text-[2.65rem] xl:text-[3.15rem]">
              أنشئ متجرك <br className="hidden lg:inline" />
              <span>وابدأ البيع </span>
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#1B4FD8] via-[#3B82F6] to-[#8B5CF6]">
                خلال دقائق معدودة
              </span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row items-center gap-4 pt-1">
              ...
              <a
                ...
                className={cn(
                  ...
                  "border border-slate-200/80 bg-white hover:bg-slate-50 hover:border-slate-350",
          ...
          <div className="lg:col-span-7 relative flex justify-center items-center h-[520px] sm:h-[580px] w-full z-10 mt-6 lg:mt-0">
            ...
            {/* 1. Main Dashboard Preview Card */}
            <div className="w-[88%] sm:w-[92%] bg-white rounded-2xl border border-slate-200/60 shadow-[0_30px_60px_rgba(0,0,0,0.03)] overflow-hidden scale-95 sm:scale-100 select-none transition-all duration-350">
              {/* Browser control bar */}
              <div className="flex items-center gap-2 px-4 py-3.5 border-b border-slate-100/70 bg-slate-50/70">
                ...
                <div className="flex-1 text-center">
                  <span className="text-[10px] sm:text-xs text-slate-400 font-mono font-bold" dir="ltr">
                    sabastore.com/dashboard
                  </span>
                </div>
              </div>
              ...
              <div className="p-4 sm:p-5 grid grid-cols-3 gap-3 bg-white text-right">
                ...
                <div className="col-span-3 mt-2 space-y-2">
                  ...
                  <div className="border border-slate-100/60 rounded-xl p-2.5 flex items-center justify-between text-[11px] hover:bg-slate-50/40 transition-colors">
            ...
            {/* 2. Phone Storefront (Overlap Left) */}
            <div className="absolute -bottom-4 left-1 sm:-left-4 z-20 w-[170px] sm:w-[195px] h-[290px] sm:h-[340px] bg-white rounded-[2rem] border-[6px] border-slate-900 shadow-[0_25px_50px_rgba(0,0,0,0.06)] overflow-hidden scale-95 sm:scale-100 transition-all duration-350">
              ...
              <div className="p-2.5 space-y-2.5 bg-[#FAF8F5] h-full overflow-y-auto no-scrollbar text-right">
                <div className="flex items-center justify-between">
                  ...
                  <div className="w-4 h-4 rounded-full bg-[#1B4FD8] flex items-center justify-center text-[7px] text-white">🛍️</div>
                </div>
                ...
                <div className="bg-white rounded-lg border border-slate-100 p-2 space-y-1">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <button className="text-[7px] bg-slate-900 text-white px-2 py-0.5 rounded font-bold hover:bg-slate-800 transition-colors">أضف</button>
                  </div>
                </div>
              </div>
            </div>

            {/* Overlap Card 1: New Order Alert (Top Left) */}
            <div className="absolute -top-4 left-0 sm:-left-8 z-30 bg-white/95 backdrop-blur-md border border-slate-100 p-3 rounded-2xl shadow-[0_10px_30px_rgba(0,0,0,0.03)] flex items-center gap-3 max-w-[190px] scale-95 sm:scale-100 transition-all duration-300 hover:scale-[1.02]">
            ...
            {/* Overlap Card 2: Payment Confirmed Notification (Mid Right) */}
            <div className="absolute top-24 -right-10 sm:-right-12 z-30 bg-white/95 backdrop-blur-md border border-slate-100 p-3 rounded-2xl shadow-[0_10px_30px_rgba(0,0,0,0.03)] flex items-center gap-3 max-w-[190px] scale-95 sm:scale-100 transition-all duration-300 hover:scale-[1.02]">
            ...
            {/* Overlap Card 3: New Product Toast (Bottom Right) */}
            <div className="absolute bottom-20 -right-8 sm:-right-10 z-30 bg-white/95 backdrop-blur-md border border-slate-100 p-3 rounded-2xl shadow-[0_10px_30px_rgba(0,0,0,0.03)] flex items-center gap-3 max-w-[190px] scale-95 sm:scale-100 transition-all duration-300 hover:scale-[1.02]">
            ...
            {/* Overlap Card 4: Free Trial Badge (Top Right) */}
            <div className="absolute -top-10 right-6 sm:right-12 z-30 bg-gradient-to-l from-[#1B4FD8] to-[#4F46E5] text-white px-4 py-2 rounded-2xl shadow-[0_10px_25px_rgba(27,79,216,0.15)] text-[10px] font-extrabold flex items-center gap-2 scale-95 sm:scale-100 transition-all duration-300 hover:scale-[1.02]">
              <Sparkles className="h-3.5 w-3.5 text-amber-300 fill-current animate-pulse" />
          ...
          <div className="bg-white/85 backdrop-blur-md border border-slate-200/50 rounded-3xl py-5 px-6 shadow-[0_8px_30px_rgba(0,0,0,0.02)] flex flex-wrap justify-between items-center gap-6">
            <div className="flex items-center gap-2 shrink-0">
              ...
              <span className="text-sm font-extrabold text-slate-800 font-cairo">
                حل متكامل وموثوق للتجارة المحلية:
              </span>
            </div>
            <div className="flex flex-wrap items-center gap-3 sm:gap-4 lg:gap-6">
              {trustItems.map((item, idx) => (
                <div
                  key={idx}
                  className="flex items-center gap-2.5 text-xs font-bold text-slate-700 bg-slate-50/80 border border-slate-100 hover:border-blue-100/50 hover:bg-white px-4 py-2.5 rounded-xl transition-all duration-300 shrink-0"
                >
      ...
      <section id="how-it-works" className="py-24 bg-slate-50/50 relative">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="text-center max-w-2xl mx-auto mb-16 space-y-3">
            <h2 className="font-cairo font-black text-slate-900 text-3xl sm:text-4xl leading-tight">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <div key={idx} className="bg-white border border-slate-100 p-8 rounded-3xl shadow-[0_4px_25px_rgba(0,0,0,0.015)] relative group hover:border-[#1B4FD8]/30 hover:shadow-lg transition-all duration-300">
                ...
                <div className="w-12 h-12 rounded-2xl bg-blue-50/80 text-xl flex items-center justify-center mb-6 shadow-sm">
                  {step.icon}
                </div>
                <h3 className="font-cairo font-bold text-slate-900 text-lg mb-2">
                  {step.title}
                </h3>
                <p className="text-slate-500 text-sm font-ibm leading-relaxed">
                  {step.desc}
                </p>
              </div>
            ))}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center relative z-10">
          ...
          <div className="lg:col-span-7 bg-white rounded-3xl border border-slate-200/60 shadow-lg p-6 sm:p-8 text-right relative">
            ...
            <div className="space-y-4">
              ...
              {/* Simulation generate return */}
              <div className="pt-1">
                <div className="bg-gradient-to-l from-amber-500/5 to-transparent border-r-4 border-amber-500 p-4 rounded-l-xl space-y-1.5 shadow-[0_4px_15px_rgba(245,158,11,0.02)]">
                  ...
                  <p className="text-xs text-slate-600 leading-relaxed font-ibm">
                    &quot;تألق بثقة وجاذبية مع حذاء الكاجوال الكلاسيكي المذهل باللون البيج الدافئ. مصمم خصيصاً ليمنح قدميك الراحة الكاملة طوال اليوم بفضل خامته الممتازة ونعله المرن والخفيف. خيار رائع للمناسبات والعمل.&quot;
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-6 grid grid-cols-2 gap-4 relative">
            ...
            <div className="bg-white border border-slate-100 p-6 rounded-2xl space-y-3 shadow-[0_8px_30px_rgba(0,0,0,0.015)] hover:border-[#1B4FD8]/20 hover:shadow-md transition-all duration-300 text-right">
              <div className="w-10 h-10 rounded-xl bg-blue-50/60 flex items-center justify-center text-xl shadow-sm border border-blue-100/50">
                📱
              </div>
            ...
            <div className="bg-white border border-slate-100 p-6 rounded-2xl space-y-3 shadow-[0_8px_30px_rgba(0,0,0,0.015)] hover:border-emerald-500/20 hover:shadow-md transition-all duration-300 text-right">
              <div className="w-10 h-10 rounded-xl bg-emerald-50/60 flex items-center justify-center text-xl shadow-sm border border-emerald-100/50">
                💳
              </div>
            ...
            <div className="bg-white border border-slate-100 p-6 rounded-2xl space-y-3 shadow-[0_8px_30px_rgba(0,0,0,0.015)] hover:border-indigo-500/20 hover:shadow-md transition-all duration-300 text-right col-span-2">
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-xl bg-indigo-50/60 flex items-center justify-center text-xl shadow-sm border border-indigo-100/50">
                  🏦
                </div>
      ...
      <section id="themes" className="py-24 bg-slate-50/50 relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center max-w-2xl mx-auto mb-16 space-y-3">
            <h2 className="font-cairo font-black text-slate-900 text-3xl sm:text-4xl leading-tight">
              ثيمات وتصاميم مجهزة لنوع نشاطك
            </h2>
            <p className="text-slate-500 text-sm font-ibm">
              اختر ثيماً يعكس علامتك التجارية وخصص الألوان والخطوط بكل حرية وسلاسة
            </p>
          </div>

          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {themeCards.map((theme, idx) => (
              <div key={idx} className="bg-white border border-slate-100/80 rounded-3xl overflow-hidden shadow-sm hover:shadow-[0_20px_45px_rgba(0,0,0,0.025)] hover:-translate-y-1 transition-all duration-300 flex flex-col text-right group">
                <div className={cn("h-44 bg-gradient-to-br flex flex-col items-center justify-center relative overflow-hidden border-b transition-all duration-500", theme.bgClass)}>
                  <span className="text-5xl mb-2 group-hover:scale-110 transition-transform duration-300">{theme.emoji}</span>
                  <span className="text-xs bg-white/90 px-3 py-1 rounded-full font-bold shadow-sm">
                    {theme.category}
                  </span>
                </div>
                <div className="p-5 flex-1 flex flex-col justify-between space-y-4">
                  <div>
                    <h3 className="font-cairo font-bold text-slate-900 text-base">
                      {theme.title}
                    </h3>
                    <p className="text-slate-500 text-xs font-ibm leading-relaxed mt-1.5">
                      {theme.desc}
                    </p>
                  </div>
                  <Link
                    href="/register"
                    className="text-xs font-bold text-[#1B4FD8] hover:text-[#1B4FD8]/80 transition-colors flex items-center justify-start gap-1"
                  >
                    <span>جرّب هذا الثيم مجاناً</span>
                    <ArrowLeft className="h-3 w-3 transition-transform group-hover:-translate-x-1 duration-200 rtl-flip" />
                  </Link>
                </div>
              </div>
            ))}
              ...
              >
                ...
                <div className="space-y-6">
                  ...
                  <div className="space-y-2">
                    <h3 className="font-cairo font-black text-slate-900 text-xl">
                      باقة {pkg.name}
                    </h3>
                    <p className="text-slate-400 text-xs font-ibm leading-relaxed min-h-[40px]">
                      {pkg.desc}
                    </p>
                  </div>
                  ...
                  <div className="flex items-baseline gap-1 py-4 border-y border-slate-100">
                    <span className="font-cairo font-black text-5xl text-slate-950 font-sans">
                      {pkg.price}
                    </span>
                  ...
                  <Link
                    ...
                    className={cn(
                      ...
                      pkg.popular
                        ...
                        : "border border-slate-200 text-slate-700 bg-slate-50/60 hover:bg-slate-100 hover:border-slate-350"
                    )}
                  >
                    {pkg.cta}
                  </Link>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="relative bg-gradient-to-br from-[#1B4FD8] to-[#4F46E5] rounded-[2rem] overflow-hidden py-16 px-8 sm:px-16 shadow-[0_20px_50px_rgba(27,79,216,0.2)] text-center">
            ...
            <div className="relative z-10 max-w-2xl mx-auto space-y-6">
              <h2 className="font-cairo font-black text-white text-3xl sm:text-4xl leading-tight">
              ...
              <div className="pt-4 flex flex-col sm:flex-row items-center justify-center gap-4">
                <Link
                  ...
                  className={cn(
                    ...
                    "hover:bg-blue-50 active:scale-98 transition-all duration-300",
      ...
      <footer className="bg-white border-t border-slate-200/40 py-12 relative z-10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <p className="text-xs text-slate-400 font-sans font-medium">
            © {new Date().getFullYear()} سبأ ستور (Saba Store). جميع الحقوق محفوظة للتجار في فلسطين والأردن.
          </p>
        </div>
      </footer>
    </div>
